...
public class CorsFilter implements Filter {
  ...
  private static final String DEFAULT_ACCESS_CONTROL_ALLOW_METHDOS_VALUE = "HEAD, POST, PUT, GET, OPTIONS, DELETE";
  ...
  public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
    ...
    LOG.info("Add CORS header to response ...");
    ...
    LOG.info("Added CORS header to response!");
