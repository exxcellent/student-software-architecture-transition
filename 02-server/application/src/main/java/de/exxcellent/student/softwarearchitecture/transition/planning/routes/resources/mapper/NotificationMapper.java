package de.exxcellent.student.softwarearchitecture.transition.planning.routes.resources.mapper;

import de.exxcellent.student.softwarearchitecture.transition.planning.routes.resources.types.notification.NotificationChannel;
import de.exxcellent.student.softwarearchitecture.transition.planning.routes.resources.types.notification.NotificationTO;
import de.exxcellent.student.softwarearchitecture.transition.planning.routes.resources.types.notification.NotificationsCTO;
...
public final class NotificationMapper {
  ...
  private static final Function<de.exxcellent.student.softwarearchitecture.transition.planning.route.api.types.notification.NotificationChannel,
      NotificationChannel>
      toChannel = channel -> {
    switch (channel) {
  ...
  private static final Function<NotificationChannel, de.exxcellent.student.softwarearchitecture.transition.planning.route.api.types.notification.NotificationChannel>
      fromChannel = channel -> {
    switch (channel) {
      case SMS: return de.exxcellent.student.softwarearchitecture.transition.planning.route.api.types.notification.NotificationChannel.SMS;
      case PHONE: return de.exxcellent.student.softwarearchitecture.transition.planning.route.api.types.notification.NotificationChannel.PHONE;
      case EMAIL: return de.exxcellent.student.softwarearchitecture.transition.planning.route.api.types.notification.NotificationChannel.EMAIL;
      case AUTOMATIC:
      default:
        return de.exxcellent.student.softwarearchitecture.transition.planning.route.api.types.notification.NotificationChannel.AUTOMATIC;
    }
  };
}
