package de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources;

import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.mapper.NotificationMapper;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.mapper.RouteMapper;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.types.notification.NotificationTO;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.types.notification.NotificationsCTO;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.types.route.RouteCTO;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.types.route.RouteCalculation;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.types.route.RouteWaypointTO;
import de.exxcellent.student.softwarearchitecture.transition.navigation.routes.resources.types.route.RoutesCTO;
