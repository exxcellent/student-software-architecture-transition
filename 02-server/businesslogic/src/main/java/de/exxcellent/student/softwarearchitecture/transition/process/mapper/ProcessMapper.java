package de.exxcellent.student.softwarearchitecture.transition.process.mapper;

import de.exxcellent.student.softwarearchitecture.transition.process.api.types.Priority;
import de.exxcellent.student.softwarearchitecture.transition.process.api.types.ProcessDO;
import de.exxcellent.student.softwarearchitecture.transition.process.api.types.Type;
import de.exxcellent.student.softwarearchitecture.transition.process.data.entities.ProcessEntity;
import de.exxcellent.student.softwarearchitecture.transition.process.data.entities.ProcessPriority;
import de.exxcellent.student.softwarearchitecture.transition.process.data.entities.ProcessType;
