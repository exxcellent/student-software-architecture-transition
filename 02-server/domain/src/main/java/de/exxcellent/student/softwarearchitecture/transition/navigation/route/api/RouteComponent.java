package de.exxcellent.student.softwarearchitecture.transition.navigation.route.api;

import de.exxcellent.student.softwarearchitecture.transition.common.dataaccess.User;
import de.exxcellent.student.softwarearchitecture.transition.navigation.route.api.types.route.RouteCalculationMode;
import de.exxcellent.student.softwarearchitecture.transition.navigation.route.api.types.route.RouteDO;
import de.exxcellent.student.softwarearchitecture.transition.navigation.route.api.types.route.UpdatedWaypointDO;
import de.exxcellent.student.softwarearchitecture.transition.navigation.route.api.types.route.WaypointDO;
