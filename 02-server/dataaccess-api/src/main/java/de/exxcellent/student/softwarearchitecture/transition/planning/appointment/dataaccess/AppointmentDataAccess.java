package de.exxcellent.student.softwarearchitecture.transition.planning.appointment.dataaccess;
...
public interface AppointmentDataAccess extends CrudDataAccess<AppointmentDTO> {
